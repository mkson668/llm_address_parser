...
class AddressParserSignature(dspy.Signature):
    """
    Parse the provided list of addresses and format them as a seperate JSON objects. No additional text is allowed.
    ...
    json_structure_definition = dspy.InputField(
        desc="The definitions of the key-value pairs"
    )
